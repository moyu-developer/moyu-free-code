...
import { Col, Row, Descriptions, Space, Button, Modal, Image, Input } from "antd";
    ...
    <CustomModalSetter title="发布管理" footer={null} trigger={props.children}>
      <Row>
        <Col span={12}>
          ...
          <Input.Search placeholder="复制网址" value="www.baidu.com" />
        </Col>
        <Col span={12}>
          <Descriptions title={pageInfo?.name} layout="horizontal" column={1}>
            ...
            <Descriptions.Item label="环境">{pageInfo.description}</Descriptions.Item>
          </Descriptions>
